...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info(f"Categircal columns encoding completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info('Read the train and test file')
            ...
            logging.info(f"Applying prerprocessing on training and testing data set")
